# -*- coding: utf-8 -*-
"""
Created on Sun May  5 15:50:53 2024
...
def scrape_university_reviews(university_name, start_page, end_page):
    base_url = 'https://gall.dcinside.com/board/view/?id=kumoh&no={}'  # {}에는 게시물 번호가 들어갈 자리입니다.
...
def save_to_database(university_name, soup, page_num):
    conn = sqlite3.connect('university_reviews_kumoh.db')
    cursor = conn.cursor()
